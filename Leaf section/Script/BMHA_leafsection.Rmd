...
#normalized tmt
leaf_section_tmt_norm_scale <- scale(t(leaf_section_tmt_normalized_mat))
...
#hierarchical clustering 
hc_tmt_norm <- hclust(as.dist(dist(t(leaf_section_tmt_norm_scale), method = "euclidean")), method = "average")
plot(as.dendrogram(hc_tmt_norm))
cutree(hc_tmt_norm,k = )
...
heat_fraction <- heatmap.2(leaf_section_tmt_norm_scale, scale = "none",dendrogram = "none", trace = "none", density.info = "none", #reorderfun=function(d,w) reorder(d,w,agglo.FUN = sum), 
                           col = rev(hcl.colors(13, palette = "ArmyRose",alpha = 1)), labCol = NA, cexRow = 0.8, key.title = "", key.xlab = "", Colv = as.dendrogram(hc_tmt_norm), Rowv = F)
                           
                           rowsep = c(3,6,9), colsep = c(486,1670,2070, 3568,4177,4621,6324,6828), sepwidth = c(0.3,0.01), sepcolor = "white", lwid = c(1,4.5), lhei = c(1,4))
...
fviz_nbclust(t(leaf_section_tmt_norm_scale), kmeans, method = "silhouette")
